...
export const kBANNER_ID = '';
export const kINTERSTIAL_ID = '';
export const KVIDEO_ID = '';
export const KAPP_ID = '';
export const kPUBLISH_BANNER_ID ='ca-app-pub-3940256099942544/6300978111';
...
// Login view alert message 


// Registration view
export const msgName = 'Please enter your name';

// Home view
export const msgDateSelect = 'Please select the date.'
export const msgCitySelect = 'Please select the city.'
export const msgSubCitySelect = 'Please select the subcity.'
...
export const msgDeleteMember = 'Are you sure to delete this member?';
